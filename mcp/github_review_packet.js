  ...
  inputSchema: {
    ...
    properties: {
      repo: {
        ...
        description: 'Repository in exact owner/repo form. URLs are not accepted.',
      },
      pull_request: {
        type: 'integer',
        minimum: 1,
      ...
      expected_head: {
        ...
        description: 'Optional read-time optimistic precondition for the PR current head SHA.',
      },
    },
  },
