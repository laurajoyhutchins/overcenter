    ...
    <main class="shell" aria-labelledby="page-title">
      <header class="masthead">
        <div>
          ...
          <p class="lede">Read-only operational evidence from the Busbar deployment: orchestration runs, leases, command journaling, and deterministic external-effect reconciliation. GitHub repositories remain authoritative for repository truth; Linear is a thin executable-work projection.</p>
        </div>
