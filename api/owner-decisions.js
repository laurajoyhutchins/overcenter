...
export default async function (_req, res) {
  try {
    ...
    const decisions = entities.flatMap((entity) => entity.owner_action.decisions.map((decision) => ({
    ...
    return res.json({ schema: 'portfolio-owner-decision-queue-v1', mode: 'shadow', count: decisions.length, decisions });
  } catch (error) {
