...
function normalize(bodyInput) {
  ...
  if (PROJECT_COMMANDS.has(command)) {
    ...
    return { command, expected_head: expectedHead, transition_id: transitionId, resume_ref: resumeRef, execution_result_json: executionResult, command_input_json: '' };
  }
  ...
  return { command, expected_head: expectedHead, transition_id: '', resume_ref: '', execution_result_json: '', command_input_json: normalizeLeaseMutationInput(body.input) };
}
