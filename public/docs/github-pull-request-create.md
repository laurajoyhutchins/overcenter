...
`github.pull_request.create` creates one same-repository pull request through the Portfolio Control Plane GitHub App while preserving exact branch authority and actor continuity.
