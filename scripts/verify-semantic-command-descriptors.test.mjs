...
const expected = ['github.actions_run.delete', 'github.apply_changeset', 'github.apply_text_replacements', 'github.pull_request.mark_ready', 'github.release.create', 'orchestration.diagnose', 'production.promote', 'production.reconcile', 'project.advance', 'project.amend', 'project.define', 'project.inspect', 'release.publish', 'work.settle'];
const expectedSurface = new Map([
  ['github.apply_changeset', 'advanced'],
  ['github.apply_text_replacements', 'advanced'],
  ['github.actions_run.delete', 'advanced'],
...
const expectedExposure = new Map([
  ...
  ['github.actions_run.delete', { worker:true, mcp:false }],
