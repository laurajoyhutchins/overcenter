...
class Github {
  constructor(){ this.main=sha(1); this.seq=10; this.forceUpdates=[]; const tree=sha(2); this.trees=new Map([[tree,new Map([['f.txt',{path:'f.txt',mode:'100644',type:'blob',sha:sha(3),content:'base\n'}]])]]); this.commits=new Map([[this.main,{sha:this.main,tree_sha:tree,message:'base',parents:[]}]]); this.branches=new Map([['main',this.main],['work/existing',this.main]]); }
