...
if (scriptTests.length === 0) throw new Error('no scripts/*.test.mjs files discovered');

// Keep the legacy lib registry proof until the native-lib migration is complete.
