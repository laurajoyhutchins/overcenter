...
const maintainedTests = [
  ...
  'project-transition-recovery-kernel-binding.test.mjs',
  ...
  'verify-execution-correctness-boundary.test.mjs',
  'verify-canonical-execution-only.test.mjs',
  'verify-execution-transaction-migrations.test.mjs',
  'verify-project-authoring-canonical-recovery-boundary.test.mjs',
  'verify-confirm-only-failure-classification.test.mjs',
