...
run(['--test', ...[...new Set(maintainedTests)].sort().map(name => `scripts/${name}`), 'lib/scheduled-cycle-completeness.test.js', 'lib/github-actions-storage.test.js', 'lib/github-auto-merge.test.js', 'lib/github-repository-rename.test.js', 'lib/linear-archive.test.js']);
