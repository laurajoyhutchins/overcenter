...
const maintainedTests = [
  ...
  'verify-project-explanation-model.test.mjs',
  ...
  'verify-project-transition-authoritative-effect-uncertainty.test.mjs',
  ...
  'verify-project-artifact-binding-command.test.mjs',
  'verify-project-artifact-binding.test.mjs',
  'verify-project-artifact-binding-runtime.test.mjs',
