...
export interface AcquireExecutionInput {
  ...
  readonly active_capability_material:string;
...
export interface ResolveOperationInput {
  readonly operation_id:string;
  readonly state:Exclude<OperationLifecycleState, 'prepared' | 'indeterminate'>;
...
export interface PutProofInput {
...
export interface CompactRunInput {
  ...
  readonly final_effect_refs:readonly unknown[] | null;
