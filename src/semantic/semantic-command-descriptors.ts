...
const DESCRIPTORS = Object.freeze({
  ...
  'github.pull_request.close':descriptor(
    ...
    'Close one exact-head pull request bound to a semantic artifact identity. Already-closed state is idempotent; uncertain mutation transport is reconciled by authoritative readback and is never blindly retried.',
  ...
  'github.issue.close':descriptor(
    'github.issue.close',
    'github_issue_close',
    'Close one exact GitHub issue bound to a semantic artifact identity. Already-closed state is idempotent; uncertain mutation transport is reconciled by authoritative readback and is never blindly retried.',
