...
import { createPostgresOrchestrationMaintenanceStore } from './orchestration-runs.js';
import { createOrchestrationMaintenanceService } from './orchestration-maintenance.js';
...
import { projectAuthoringRecoveryFor } from './project-authoring-overcenter-host.js';
...
export function createPostgresSubjectAwareOrchestrationMaintenanceService(options = {}) {
  ...
  return createOrchestrationMaintenanceService({
    ...
    leases,
    projectAuthoringRecovery:options.projectAuthoringRecovery || projectAuthoringRecoveryFor({ db:dbBinding }),
