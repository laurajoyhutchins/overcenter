...
import { createGithubIntegrationConvergenceForRuntime } from './github-integration-convergence.js';
  ...
  const compactRecoveries = options.compactRecoveries || (typeof withGitHubAppApiClient === 'function'
    ? [
        ...
        Object.freeze({
          ...
          reconcilePending:(request) => createGithubIntegrationConvergenceForRuntime({
            db:dbBinding,
            api:options.api,
            withGitHubAppApiClient,
            now:options.now,
