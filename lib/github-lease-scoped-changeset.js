...
function validateInput(input){
  ...
  return {lease_ref:validateLeaseRef(input.lease_ref),changes:input.changes,commit_message:input.commit_message,coalesce_previous_mechanical:coalescePreviousMechanical};
}
...
export async function resolveGithubLeaseScopedChangeset(input,{executionAuthority,readBranch}={}){
  ...
  const explicit={
    ...
    ...(request.coalesce_previous_mechanical?{coalesce_previous_mechanical:true}:{}),
  };
