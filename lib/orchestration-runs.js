  ...
  async function finish(input) {
    ...
    if (typeof store.activeLeaseForRun === 'function') {
      ...
      if (activeLease && request.active_lease_settlement) {
        ...
        await leases.settleByRef(settlement);
    ...
    return { ok: true, ...publicRun(updated), idempotent_replay: false, run_receipt: await receipt({ run_id: runId }), work_authority_changed: workAuthorityChanged };
  }
