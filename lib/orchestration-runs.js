...
const JOURNALED_EXTERNAL_EFFECT_COMMANDS = new Set(['github.apply_changeset','github.delete_branch','github.required_checks.ensure','github.pages.ensure','github.integration.reconcile','linear.archive','portfolio.reconcile_work_surface']);
