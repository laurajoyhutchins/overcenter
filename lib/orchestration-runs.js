...
export function createPostgresOrchestrationMaintenanceStore(dbBinding = db) {
  return {
    ...
    async recordResolution(invocationId, kind, evidence) { return (await dbBinding.query('INSERT INTO orchestration_invocation_resolutions (invocation_id,resolution_kind,evidence) VALUES ($1,$2,$3::jsonb) RETURNING *', [invocationId,kind,JSON.stringify(evidence || {})])).rows?.[0] || null; },
