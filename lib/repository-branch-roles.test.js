...
export async function runRepositoryBranchRoleTests() {
  ...
  await test('development role is explicit and preserves configured safe branch', async () => {
    ...
    assert(missingCode === 'REPOSITORY_BRANCH_ROLE_INVALID', `missing development branch unexpectedly produced ${missingCode}`);
