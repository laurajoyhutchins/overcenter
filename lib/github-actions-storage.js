...
const OPERATIONS = new Set(['inspect', 'select_redundant_coverage', 'delete_artifacts', 'set_retention']);
...
export function normalizeGithubActionsStorageRequest(input) {
  ...
  if (!OPERATIONS.has(operation)) fail('INVALID_REQUEST', 'operation must be inspect, select_redundant_coverage, delete_artifacts, or set_retention');
