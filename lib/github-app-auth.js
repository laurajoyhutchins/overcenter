...
const GITHUB_APP_CAPABILITIES = Object.freeze({
  ...
  artifact_binding: Object.freeze({ permissions: Object.freeze({ metadata: "read", issues: "read", pull_requests: "read" }), fallback: Object.freeze({ class: "fail_closed", mechanism: null }) }),
