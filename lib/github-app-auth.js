...
export function createInstallationResolver(options = {}) {
...
export function installationTokenRequestBody(repo, profileName, repositoryScope = "repository") {
...
export async function withInstallationTokenClient(auth, callback, deps = {}) {
