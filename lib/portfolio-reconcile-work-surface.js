...
export function createPostgresPortfolioReceiptStore(dbBinding) {
...
export function createPostgresPortfolioReconcileService(options = {}) {
  ...
  if ((!options.identityStore || !options.receiptStore || !options.leaseStore || !options.repositoryLifecycle) && (!dbBinding || typeof dbBinding.query !== 'function')) fail('RUNTIME_PROVIDER_MISSING', 'database provider is required', { provider:'db' }, 500);
