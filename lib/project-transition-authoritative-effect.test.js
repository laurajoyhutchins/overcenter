...
const authority={subject:'project_transition',project_ref:'github:owner/repo',transition_id:'t1',repository:'owner/repo',authority:{revision:AUTHORITY_REVISION}};
const workspace={repository:'owner/repo',branch:'work/t1',authority_revision:AUTHORITY_REVISION};
const request={run_id:'run-1',target:{project_ref:'github:owner/repo',horizon:{kind:'transition',ref:'t1'}},execution_result:{disposition:'completed',evidence:[{kind:'verified_candidate',ref:SHA}]}};
