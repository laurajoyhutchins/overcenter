...
export async function projectTransitionSuspension(latest, transition) {
  ...
  const revisionFingerprint = await projectTransitionRevisionFingerprint({
    transition_id:transition.id, priority:transition.priority, executor:transition.executor, phase_bindings:transition.phase_bindings, execution_intent:transition.execution_intent,
  });
