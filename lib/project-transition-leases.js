...
async function buildAndReplaySettlementCertificate(store, verified, row, evidence, observedAt) {
  ...
  if (typeof store.getLatestSettledLeaseForTransition !== 'function') fail('PROJECT_TRANSITION_CERTIFICATE_STORAGE_UNAVAILABLE', 'completed settlement cannot load predecessor certificates');
