...
async function buildAndReplaySettlementCertificate(store, verified, row, evidence, observedAt) {
  ...
  const certificate = await createProjectTransitionSettlementCertificate({
    project_ref:row.project_ref,
    transition,
    authority:verified.authority,
    evidence,
    predecessor_certificates:predecessorCertificates,
    predecessor_transitions:predecessorTransitions,
  });
  await replayProjectTransitionSettlementCertificate({
    project_ref:row.project_ref,
    transition,
    authority:verified.authority,
    certificate,
