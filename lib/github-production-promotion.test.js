...
export async function runGithubProductionPromotionTests() {
  ...
  await test('readback failure after production update preserves possible mutation', async () => {
    const api = github();
  ...
  await test('receipt failure after confirmed production update preserves possible mutation', async () => {
    const api = github();
