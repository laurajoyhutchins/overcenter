...
export const OVERCENTER_METRICS_CONTRACT = Object.freeze({
  ...
  dimensions:Object.freeze({
    ...
    execution_origin:Object.freeze({ values:Object.freeze(['system','scheduler','agent','operator','recovery','unknown']), authoritative:true }),
  }),
  durable_correlation_facts:Object.freeze({
    source:'command_invocations.request_projection.metrics_correlation',
    fields:Object.freeze(['execution_origin','reasoning_boundary_id','recovery_decision_id','recovery_attempt_id','packet_schema']),
    historical_missing:'unknown',
    rule:'Correlation facts reuse durable command invocation identity. Missing historical attribution remains unknown; prompt contents and free-form reasoning are never persisted.',
  }),
