...
export async function coalesceGithubLeaseScopedChangeset(input,options={}){
  ...
  const row=(await db.query(
    `SELECT receipt FROM github_changeset_receipts
  ...
  return withGithub({repo:prepared.workspace.repository,branch:prepared.workspace.branch,changes:input.changes},(github)=>coalesceGithubMechanicalChangeset({
