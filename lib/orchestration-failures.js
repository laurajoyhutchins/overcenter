...
export function classifyOrchestrationFailure(input = {}) {
  ...
  } else if (!mayHaveMutated && (code === 'PROJECT_AUTHORING_INTEGRATION_PENDING' || code === 'PRODUCTION_RECONCILIATION_SOURCE_NOT_VERIFIED' || code === 'PRODUCTION_PROMOTION_SOURCE_NOT_VERIFIED')) {
    result = base(
      'WAITING_EXTERNAL_VERIFICATION',
      false,
