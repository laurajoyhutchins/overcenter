...
class FakeAuthority {
  constructor(items) { this.items = new Map(items.map(x => [x.identifier, clone(x)])); this.rev = 1; this.failNext = false; this.ambiguousAfterNext = false; this.commentWrites = 0; this.history = []; }
