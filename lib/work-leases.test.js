...
class MemoryStore {
  ...
  async listContinuationCandidates(workRef,gate) { return [...this.leases.values()].filter(l=>l.work_ref===workRef&&((l.status==='settled'&&l.settle_plan?.lane===gate&&l.settle_plan?.continuation)||(l.status==='expired'&&l.gate===gate&&l.reconciliation?.restored===true))).sort((a,b)=>String(b.settled_at||b.updated_at||b.created_at).localeCompare(String(a.settled_at||a.updated_at||a.created_at))); }
