...
async function runOrchestrationVerification() {
  const [orchestration, leases, workerTransport, portfolioReconcile, workSurfacePolicy, deterministicWorkSettlement, linearArchive, linearMaintenance, scheduledCycleCompleteness, repositoryDisposition, repositoryDisposal] = await Promise.all([
