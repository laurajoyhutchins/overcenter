...
async function runOrchestrationVerification() {
  const [orchestration, leases, workerTransport, portfolioReconcile, workSurfacePolicy, deterministicWorkSettlement, linearArchive, linearMaintenance, scheduledCycleCompleteness, scheduledExecutionContext, repositoryDisposition, repositoryDisposal] = await Promise.all([
