...
class FakeLinear {
  constructor() {
    ...
    this.project = {
      ...
      labels: [
        { id: 'lane-enable', name: 'lane:enable' },
  ...
  addIssue(overrides = {}) {
    ...
    const issue = {
      ...
      labels: clone(overrides.labels || [{ id: 'lane-enable', name: 'lane:enable' }]),
...
// Portfolio reconcile cases execute directly through node:test.

  await (test('01 new GitHub issue creates one Linear issue', async () => {
  ...
  await (test('02 exact semantic replay reuses canonical item without duplicate', async () => {
  ...
  await (test('03 Repository + Authority markers bootstrap missing durable identity', async () => {
  ...
  await (test('04 existing issue discovery adopts identity map', async () => {
  ...
  await (test('05 exact existing projection is reused without description churn', async () => {
  ...
  await (test('06 explicit title update changes only title', async () => {
  ...
  await (test('07 explicit priority update changes only priority', async () => {
  ...
  await (test('08 explicit outcome update materially changes the minimal packet', async () => {
  ...
  await (test('09 formatting-only difference does not churn description', async () => {
  ...
  await (test('10 stale GitHub expected_revision is rejected', async () => {
  ...
  await (test('11 closed GitHub issue on new admission is rejected', async () => {
  ...
  await (test('12 closed GitHub issue evicts active Linear work to Done', async () => {
  ...
  await (test('13 archived repository is not admitted', async () => {
  ...
  await (test('13b canonical SUPERSEDED disposition blocks projection and returns successor', async () => {
    const h = harness();
  ...
  await (test('14 GitHub issue not found is rejected', async () => {
  ...
  await (test('15 GitHub App not installed is stable rejection', async () => {
  ...
  await (test('16 GitHub permission failure is request-level failure', async () => {
  ...
  await (test('17 Linear permission failure is request-level failure', async () => {
  ...
  await (test('18 duplicate Linear representations return IDENTITY_CONFLICT', async () => {
  ...
  await (test('19 active work lease prevents unsafe update', async () => {
  ...
  await (test('20 expired lease is not an ownership blocker', async () => {
  ...
  await (test('21 In Progress without active lease is not treated as owned', async () => {
  ...
  await (test('22 invalid lane is rejected', async () => {
  ...
  await (test('23 invalid state is rejected', async () => {
  ...
  await (test('24 new item cannot enter In Progress', async () => {
  ...
  await (test('25 unresolved dependency rejects without placeholder', async () => {
  ...
  await (test('26 existing dependency is reused idempotently', async () => {
  ...
  await (test('27 duplicate dependency declarations do not duplicate relation', async () => {
  ...
  await (test('28 Linear concurrent edit returns optimistic conflict', async () => {
  ...
  await (test('29 idempotency replay returns stored receipt', async () => {
  ...
  await (test('30 idempotency key semantic conflict is request-level conflict', async () => {
  ...
  await (test('31 mixed batch returns create + reuse + reject independently', async () => {
  ...
  await (test('32 later batch rejection does not corrupt prior success', async () => {
  ...
  await (test('33 dry-run creates no Linear issue', async () => {
  ...
  await (test('34 dry-run creates no identity row or receipt', async () => {
  ...
  await (test('35 unknown input fields are rejected', async () => {
  ...
  await (test('36 GitHub issue body is not persisted in Hatchable identity state', async () => {
  ...
  await (test('37 GitHub issue body is not copied into Linear', async () => {
  ...
  await (test('38 secrets are not logged', async () => {
  ...
  await (test('39 Backlog requires explicit promotion condition', async () => {
  ...
  await (test('40 new work enters only through Enable', async () => {
    const h = harness();
    for (const lane of ['lane:source-implementation','lane:repo-implementation','lane:integration','lane:verification']) {
      const req = baseRequest({ idempotency_key:`downstream-${lane}` }); req.items[0].projection.lane = lane; const r = await reconcile(h, req);
      check(r.items[0].reason === 'PHASE_TICKET_NOT_ADMITTED', `new demand entered downstream lane ${lane}`);
    }
  }));

  await (test('41 proven pre-effect failure abandons receipt and retries normally', async () => {
    const h = harness();
  ...
  await (test('42 Linear create succeeds, response is lost, replay discovers exact work without duplicate', async () => {
    const h = harness();
  ...
  await (test('43 completed item progress survives when a later item becomes indeterminate', async () => {
    const h = harness();
  ...
  await (test('44 Linear update succeeds, response is lost, replay reconciles current projection', async () => {
    const h = harness();
  ...
  await (test('45 dependency relation succeeds, later response is lost, replay does not duplicate relation', async () => {
    const h = harness();
  ...
  await (test('46 material source authority change during recovery fails closed with structured conflict', async () => {
    const h = harness();
    h.linear.loseCreateResponseOnCall = 1;
    const first = await reconcile(h);
  ...
  await (test('47 reconciliation request accepts a non-legacy campaign project', async () => {
  ...
  await (test('48 new admission creates work directly in the selected campaign project', async () => {
    const h = harness();
  ...
  await (test('49 existing canonical work can move into the selected campaign project without changing identity', async () => {
    const h = harness();
  ...
  await (test('50 source fallback discovery searches the whole team, not only the target project', async () => {
    const calls = [];
    const apiBinding = {
      async call(name, request) {
        ...
        if (query.includes('query PortfolioSourceIdentityBootstrap')) {
  ...
  await (test('51 non-executable candidate is not admitted', async () => {
  ...
  await (test('52 deterministic bookkeeping is not projected as reasoning work', async () => {
  ...
  await (test('53 explicit supersession evicts existing work and stale source cannot resurrect it', async () => {
  ...
  await (test('54 one roadmap source can project distinct bounded units', async () => {
  ...
  await (test('55 bounded frontier limits and replenishes after settlement', async () => {
  ...
  await (test('56 historical record can become terminal without deletion', async () => {
  ...
  await (test('57 canonical key prevents duplicate projection', async () => {
  ...
  await (test('58 disposed repository evicts an existing active projection', async () => {
  ...
  await (test('59 managed Linear packet contains only execution facts and authority references', async () => {
