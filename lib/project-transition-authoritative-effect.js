...
export function projectTransitionAuthoritativeEffectConfirmationFor(options = {}) {
  ...
  return Object.freeze({
    async confirm(request = {}) {
      ...
      if (!pull) return Object.freeze({ confirmed:false, reason:'authoritative_effect_not_observed' });
      if (!mergedPullRequest(pull, candidate, workspace.branch, developmentBranch) && typeof integrateCandidate === 'function') {
