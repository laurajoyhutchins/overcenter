...
export function assertSourceCoordinates(input = {}) {
  ...
  if (expectedHead !== observedHead) fail('GITHUB_HEAD_MISMATCH', 'GitHub main head changed before source materialization.', { expected_github_head: expectedHead, actual_github_head: observedHead });
