...
const specs = {
  ...
  'project.inspect': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => projectInspectForRuntime(runtime).inspect(request),
    statusForFailure: () => null,
