...
const specs = {
  'github.release.create': {
    allowed: new Set(['repo','target_sha','tag_name','name','body','draft','prerelease','expected_state','idempotency_key','run_id']),
    required: new Set(['repo','target_sha','tag_name','name','body','draft','prerelease','expected_state','idempotency_key','run_id']),
  ...
  'work.settle': {
    allowed: new Set(['lease_ref','disposition','evidence','reason','promotion_condition','requeue_class','operating_condition','continuation','lifecycle_facts']),
