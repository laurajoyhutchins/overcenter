...
function invocationObservationRuntimeFor(runtime = {}) {
  if (runtime.invocationObservation
      && typeof runtime.invocationObservation.peek === 'function'
      && typeof runtime.invocationObservation.attach === 'function') return runtime.invocationObservation;
  return invocationObservationFor(requireRuntimeDb(runtime));
}
...
const invocationPeekDescriptor = semanticCommandDescriptor('invocation.peek');
const invocationAttachDescriptor = semanticCommandDescriptor('invocation.attach');
...
const specs = {
  ...
  'invocation.peek': {
    allowed: new Set(invocationPeekDescriptor.semantic_fields),
    required: new Set(invocationPeekDescriptor.required_fields),
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => invocationObservationRuntimeFor(runtime).peek(request),
    statusForFailure: () => null,
    defaultError: 'INVOCATION_PEEK_ERROR',
    defaultMessage: 'invocation.peek failed',
  },
  'invocation.attach': {
    allowed: new Set(invocationAttachDescriptor.semantic_fields),
    required: new Set(invocationAttachDescriptor.required_fields),
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => invocationObservationRuntimeFor(runtime).attach(request),
    statusForFailure: () => null,
