...
function invocationObservationFor(runtime = {}) {
  ...
  return createPostgresInvocationObservationService({ db:runtime.db || hatchableDb });
}
...
const specs = {
  ...
  'invocation.peek': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => invocationObservationFor(runtime).peek(request),
  ...
  'invocation.attach': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => invocationObservationFor(runtime).attach(request),
