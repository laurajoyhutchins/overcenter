...
function projectInspectionFor(runtime = {}) {
  ...
  return projectInspectForGitHub({ db:requireRuntimeDb(runtime), createGitHubProjectGraphRuntime });
}
...
function releasePublishingRuntimeFor(runtime = {}) {
  ...
  return releasePublishingFor({ db:requireRuntimeDb(runtime) });
}
...
function workCheckpointFor(runtime = {}) {
  ...
  return createPostgresSubjectAwareLeaseCheckpointService({ db:requireRuntimeDb(runtime), api:runtime.api });
}
...
function workHeartbeatFor(runtime = {}) {
  ...
  return createPostgresSubjectAwareLeaseHeartbeatService({ db:requireRuntimeDb(runtime), api:runtime.api });
}
...
function workSettlementFor(runtime = {}) {
  ...
  return createPostgresSubjectAwareLeaseSettlementService({ db:requireRuntimeDb(runtime), api:runtime.api });
}
