...
import { closeGithubPullRequest, closeGithubIssue } from 'lib/github-work-surface-close.js';
...
const specs = {
  ...
  'github.pull_request.close': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request) => closeGithubPullRequest(request),
    statusForFailure: () => null,
  ...
  'github.issue.close': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request) => closeGithubIssue(request),
    statusForFailure: () => null,
