...
const specs = {
  ...
  'project.artifact.bind': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => projectArtifactBindingFor({ db:requireRuntimeDb(runtime), withGitHubAppApiClient:requireGitHubAppAuth(runtime).withApiClient }).bind(request),
    statusForFailure: () => null,
