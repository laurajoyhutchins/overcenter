...
function invocationReconnectRuntimeFor(runtime = {}) {
  if (runtime.invocationReconnect && typeof runtime.invocationReconnect.attach === 'function' && typeof runtime.invocationReconnect.peek === 'function') return runtime.invocationReconnect;
  return invocationReconnectFor({ db:runtime.db || hatchableDb });
}
...
const specs = {
  ...
  'invocation.attach': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => invocationReconnectRuntimeFor(runtime).attach(request),
  ...
  'invocation.peek': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => invocationReconnectRuntimeFor(runtime).peek(request),
    statusForFailure: statusForInvocationReconnectError,
