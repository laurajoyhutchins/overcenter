...
import { closeGithubIssueWithGitHubApp, closeGithubPullRequestWithGitHubApp } from 'lib/github-work-surface-retirement-github-app.js';
...
const specs = {
  ...
  'github.issue.close': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request) => closeGithubIssueWithGitHubApp(request),
  ...
  'github.pull_request.close': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request) => closeGithubPullRequestWithGitHubApp(request),
    statusForFailure: () => null,
