...
const specs = {
  ...
  'production.reconcile': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => productionReconciliationFor({ db:requireRuntimeDb(runtime) }).reconcile(request),
    statusForFailure: () => null,
  ...
  'production.promote': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => productionPromotionFor({ db:requireRuntimeDb(runtime) }).promote(request),
    statusForFailure: () => null,
