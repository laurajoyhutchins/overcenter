...
import { createGithubReleaseWithExecutionKernel } from 'lib/github-release-runtime.js';
...
function releasePublishingRuntimeFor(runtime = {}) {
  ...
  return releasePublishingFor({
    db:requireRuntimeDb(runtime),
    withGitHubAppApiClient:requireGitHubAppAuth(runtime).withApiClient,
    executionTransactionStore:runtime.executionTransactionStore,
    runId:runtime.invocationContext?.run_id || null,
    authorityEpoch:runtime.invocationContext?.authority_epoch ?? null,
  });
}
...
function githubMutationsFor(runtime = {}) {
  ...
  return createGithubWorkerMutationRuntime({
    ...
    withGitHubAppApiClient:requireGitHubAppAuth(runtime).withApiClient,
    executionTransactionStore:runtime.executionTransactionStore,
    run_id:runtime.invocationContext?.run_id || null,
    authority_epoch:runtime.invocationContext?.authority_epoch ?? null,
  });
}
...
const specs = {
  ...
  'github.release.create': {
    ...
    canonicalize: async (input) => ({ ...input }),
    execute: (request, runtime) => createGithubReleaseWithExecutionKernel(request, {
      db:requireRuntimeDb(runtime),
      withGitHubAppApiClient:requireGitHubAppAuth(runtime).withApiClient,
      executionTransactionStore:runtime.executionTransactionStore,
      run_id:runtime.invocationContext?.run_id || null,
