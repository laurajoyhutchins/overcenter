...
function workCheckpointFor(runtime = {}) {
  ...
  return createPostgresSubjectAwareLeaseCheckpointService({ db:requireRuntimeDb(runtime) });
}
...
function workHeartbeatFor(runtime = {}) {
  ...
  return createPostgresSubjectAwareLeaseHeartbeatService({ db:requireRuntimeDb(runtime) });
}
...
function workSettlementFor(runtime = {}) {
  ...
  return createPostgresSubjectAwareLeaseSettlementService({ db:requireRuntimeDb(runtime) });
}
