...
export function queryProjectExplanation(input = {}, query = {}) {
  ...
  if (kind === 'project') {
    return Object.freeze({ schema:'project-explanation-query-v1', query:Object.freeze({ kind:'project' }), project_ref:explanation.project_ref, authority_revision:explanation.authority_revision, result:explanation.summary });
  }
  if (kind === 'transition') {
    ...
    return Object.freeze({ schema:'project-explanation-query-v1', query:Object.freeze({ kind:'transition', transition_id:transitionId }), project_ref:explanation.project_ref, authority_revision:explanation.authority_revision, result });
  }
