...
function normalizeExecutionResult(value) {
  ...
  const allowed = new Set(['disposition','evidence','reason','promotion_condition']);
  ...
  return Object.freeze({ disposition, evidence:Object.freeze([...evidence]), reason:optionalReason(value.reason), promotion_condition:optionalReason(value.promotion_condition) });
}
