...
async function testProjectsInspectThroughAuthoritativeGraphBoundary() {
  ...
  assertEqual(inspection, {
    ...
    proof_states:[
      {
        schema:'project-transition-proof-state-v1',
        transition_id:'compact-agent-semantic-surface',
        desired_outcome:null,
        obligation_fingerprint:null,
        authority:{ kind:'github', repository:'laurajoyhutchins/overcenter', revision:'0123456789abcdef0123456789abcdef01234567', derivation:'overcenter-project-graph-v1' },
        acceptance_obligations:[],
        unresolved_obligations:[],
        valid_evidence:[],
        stale:{ value:false, evidence_kinds:[] },
        next_legal_action:{ kind:'external_wait', stop_condition:'another execution owns the active transition lease' },
      },
      {
        schema:'project-transition-proof-state-v1',
        transition_id:'other-ready-work',
        desired_outcome:null,
        obligation_fingerprint:null,
        authority:{ kind:'github', repository:'laurajoyhutchins/overcenter', revision:'0123456789abcdef0123456789abcdef01234567', derivation:'overcenter-project-graph-v1' },
        acceptance_obligations:[],
        ...
        valid_evidence:[],
        stale:{ value:false, evidence_kinds:[] },
        next_legal_action:{ kind:'reasoning_judgment', stop_condition:'perform only the bounded judgment-heavy work required by the execution intent' },
      },
    ],
...
export async function runProjectInspectOvercenterHostTests() {
  ...
  await testProjectInspectBoundsOccupancyConcurrencyWithoutTruncatingFrontier();
  await testProjectInspectDoesNotPresentBlockedSettlementAsAvailable();
  ...
  return { ok:true, tests:6 + agentSession.tests };
}
