...
async function testProjectsInspectThroughAuthoritativeGraphBoundary() {
  ...
  assertEqual(occupancyCalls, [
    { project_ref:'github:laurajoyhutchins/overcenter', transition_id:'compact-agent-semantic-surface', observed_at:observedAt, authority_revision:'0123456789abcdef0123456789abcdef01234567' },
    { project_ref:'github:laurajoyhutchins/overcenter', transition_id:'other-ready-work', observed_at:observedAt, authority_revision:'0123456789abcdef0123456789abcdef01234567' },
...
export async function runProjectInspectOvercenterHostTests() {
  ...
  return { ok:true, tests:5 + agentSession.tests };
}
