...
// Native node:test owns case registration and failure reporting.
  ...
  await test('project definition reads use the narrow contents-read capability', async()=>{
  ...
  await test('project definition discovery selects one canonical source document', async()=>{
  ...
  // End native project repository facts suite.
