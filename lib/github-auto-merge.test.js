...
// Legacy suite wrapper removed during node:test migration.
  ...
  test('request is exact and boolean-valued', async () => {
  ...
  test('already compliant is an idempotent verified success', async () => {
  ...
  test('ensure writes the desired value and verifies authoritative state', async () => {
  ...
  test('expected state mismatch fails closed before mutation', async () => {
    const client = queuedClient([{ method: 'GET', result: repository(true) }]);
  ...
  test('uncertain mutation reconciles authoritative desired state instead of replaying', async () => {
    const client = queuedClient([
      { method: 'GET', result: repository(false) },
  ...
  test('failed post-write verification remains explicitly indeterminate', async () => {
    const client = queuedClient([
      { method: 'GET', result: repository(false) },
  ...
  test('command-response semantics classify stale state and indeterminate mutation mechanically', async () => {
