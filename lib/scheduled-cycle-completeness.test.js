...
// Tests execute directly through Node's native test runner.
...
// Native node:test registrations are discovered directly.

  test('ledger defines the five ordinary scheduled participants and exact offsets', async () => {
  ...
  test('scheduler policy does not duplicate lifecycle stage or command membership', async () => {
  ...
  test('acknowledgement keeps reported prompt start distinct from first external evidence', async () => {
  ...
  test('idempotent acknowledgement replay does not manufacture a duplicate', async () => {
  ...
  test('duplicate and reordered transitions are explicit classifications', async () => {
  ...
  test('deadline reconciliation appends durable missing evidence without inventing a start', async () => {
  ...
  test('worker run evidence correlates claim and terminal execution without replacing scheduler evidence', async () => {
  ...
  test('healthy no-op cycle is provable from explicit participant evidence rather than HTTP success', async () => {
    const store = new FakeStore();
  ...
  test('execution health remains provable when scheduler acceptance evidence is unavailable', async () => {
  ...
  test('ambiguous acknowledgement remains distinct from missing and failed-closed', async () => {
  ...
  test('cycle record retains bounded scheduler, request, Linear, production, and source coordinates', async () => {
  ...
  test('runtime-owned deterministic run projects start claim and completion without worker acknowledgements', async () => {
    const store = new FakeStore();
  ...
  test('runtime-owned blocked run derives failed-closed and suppresses missing reconciliation', async () => {
    const store = new FakeStore();
  ...
  // Native test failures are reported by node:test.
