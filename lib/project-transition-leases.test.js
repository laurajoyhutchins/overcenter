import { createExecutionAuthorityService } from './execution-authority.js';
...
function executionAuthorityFixture() {
  ...
  const service=createExecutionAuthorityService({store,authoritative:{async getIssue(){linearReads+=1;throw new Error('project transition authority must not read Linear');}},projectTransitions,now:()=> '2026-08-27T13:00:00Z'});
