...
// Cases execute directly through native node:test discovery.
  ...
  test('default-branch authority contract normalizes deterministic repository binding', async()=>{
  ...
  test('pull-request authority contract requires exact PR coordinate', async()=>{
    const result = normalizeProjectAuthorityResolutionContract({
  ...
  test('contract rejects ambiguous or non-GitHub repository coordinates', async()=>{
  ...
  test('contract rejects unsupported revision policy', async()=>{
  ...
  test('pull-request coordinate is required only for pull-request policy', async()=>{
  ...
  test('contract rejects empty semantic identities', async()=>{
