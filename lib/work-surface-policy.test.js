...
// Native node:test owns execution and failure aggregation.
  ...
  test('strict executable action is admitted', async () => {
  ...
  test('missing concrete next action is not admitted', async () => {
    const result = classifyWorkSurfaceProjection({
  ...
  test('deterministic bookkeeping becomes DERIVED_STATE', async () => {
    const result = classifyWorkSurfaceProjection({
  ...
  test('human wait remains visible but not ordinary Todo', async () => {
    const result = classifyWorkSurfaceProjection({
  ...
  test('external blocker remains visible only with a concrete promotion condition', async () => {
    const result = classifyWorkSurfaceProjection({
  ...
  test('terminal dispositions never become visible', async () => {
  ...
  test('source unit gives a stable distinct identity under one roadmap issue', async () => {
  ...
  test('canonical key deduplicates multiple source observations', async () => {
  ...
  test('U.S. jurisdiction campaign has a bounded frontier of three', async () => {
    assert(frontierLimitForProject('U.S. Jurisdiction Coverage') === 3, 'jurisdiction frontier is not bounded to three');
  });

  test('disposition enum stays intentionally small and complete', async () => {
