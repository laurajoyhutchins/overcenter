...
const DESCRIPTORS = Object.freeze({
    ...
    'orchestration.metrics': descriptor('orchestration.metrics', 'orchestration.metrics', 'Read authoritative Overcenter outcome and orchestration metrics for a bounded time window. This operator surface is measurement-only: it grants no mutation authority and cannot settle project state.', orchestrationMetricsSchema, 'operator', INTERNAL_EXPOSURE),
