...
const DESCRIPTORS = Object.freeze({
    ...
    'github.pull_request.close': descriptor('github.pull_request.close', 'github_pull_request_close', 'Close one exact-head pull request through the Overcenter GitHub App after project-level artifact retirement authorization. Idempotent closed state and uncertain transport are reconciled by fresh authoritative readback.', githubPullRequestCloseSchema, 'advanced', INTERNAL_EXPOSURE),
    'github.issue.close': descriptor('github.issue.close', 'github_issue_close', 'Close one exact GitHub issue through the Overcenter GitHub App after project-level artifact retirement authorization. Pull-request objects are rejected, already-closed state is idempotent, and uncertain transport is reconciled by fresh authoritative readback.', githubIssueCloseSchema, 'advanced', INTERNAL_EXPOSURE),
