...
const githubApplyChangesetSchema = Object.freeze({
    ...
    properties: {
        ...
        coalesce_mechanical: { type: 'boolean', description: 'When true, replace the exact immediately preceding same-workspace mechanical head with one combined mechanical repair commit. Requires exact-head fencing and fails closed unless the current head is itself mechanical.' },
    },
    additionalProperties: false,
});
