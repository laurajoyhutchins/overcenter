...
const DESCRIPTORS = Object.freeze({
    ...
    'github.actions_run.delete': descriptor('github.actions_run.delete', 'github_actions_run_delete', 'Delete one exact GitHub Actions workflow run through the installed GitHub App. The command binds the effect to repository, numeric workflow-run identity, and expected head commit SHA; mismatches fail closed before deletion, absent runs replay successfully, and dispatched mutations are not considered successful until authoritative readback proves absence.', githubActionsRunDeleteSchema, 'advanced', INTERNAL_EXPOSURE),
