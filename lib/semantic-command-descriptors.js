...
const githubApplyChangesetSchema = Object.freeze({
    ...
    properties: {
        ...
        changes: { type: 'array', minItems: 1, items: githubChangesetChangeSchema, description: 'Complete repository changes. Repository, branch, base, expected head, retry identity, and GitHub App credentials are derived from the lease.' },
...
const githubIntegrationReconcileSchema = githubPullRequestMarkReadySchema;
...
const DESCRIPTORS = Object.freeze({
    ...
    'github.integration.reconcile': descriptor('github.integration.reconcile', 'github_integration_reconcile', 'Converge one exact-head pull request integration intent through durable Overcenter recovery. Callers provide only repository, pull request, initial expected head, and optional run correlation; refreshed heads and merge identities are owned by durable continuation state.', githubIntegrationReconcileSchema, 'advanced', INTERNAL_EXPOSURE),
