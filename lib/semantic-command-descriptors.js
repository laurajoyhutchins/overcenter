...
const DESCRIPTORS = Object.freeze({
    ...
    'project.advance': descriptor('project.advance', 'project.advance', 'Advance an authoritative project graph by repository-owned project identity only. Run creation or resumption, horizon selection, lease acquisition, settlement choreography, and continuation remain mechanically owned behind the semantic boundary; MCP exposure stays disabled until a runtime adapter can preserve those invariants.', projectAdvanceSchema, 'primary', Object.freeze({ worker: true, mcp: false })),
