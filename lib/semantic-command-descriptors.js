...
const DESCRIPTORS = Object.freeze({
    ...
    'project.artifact.bind': descriptor('project.artifact.bind', 'project.artifact.bind', 'Explicitly bind one exact GitHub issue or pull request to one exact project obligation as a full-coverage equivalence judgment. Overcenter revalidates exact project authority, reads exact provider identity, and persists append-only binding evidence; titles, labels, and prose never create bindings.', projectArtifactBindSchema, 'primary', WORKER_AND_MCP_EXPOSURE),
