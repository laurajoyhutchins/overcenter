...
const PROJECT_AUTHORING_DESCRIPTORS = Object.freeze({
    'project.define': descriptor('project.define', 'project.define', 'Define canonical repository-owned project graph facts at an exact observed Git revision. Overcenter owns repository layout, mutation fencing, retry identity, durable GitHub mutation, and authoritative graph readback.', projectDefineSchema, Object.freeze({ worker: true, mcp: true })),
