...
const DESCRIPTORS = Object.freeze({
    ...
    'invocation.peek': descriptor('invocation.peek', 'invocation.peek', 'Read the bounded authoritative state of one exact durable command invocation without reconstructing prior session context or creating new execution state.', invocationObservationSchema, 'primary', WORKER_AND_MCP_EXPOSURE),
    'invocation.attach': descriptor('invocation.attach', 'invocation.attach', 'Reconnect to one exact durable command invocation and return its stable invocation reference plus current bounded authoritative observation without creating parallel session state.', invocationObservationSchema, 'primary', WORKER_AND_MCP_EXPOSURE),
