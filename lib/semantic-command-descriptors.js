...
const githubApplyChangesetSchema = Object.freeze({
    ...
    properties: {
        ...
        coalesce_mechanical_head: { type: 'boolean', description: 'Canonical recovery for MECHANICAL_CHANGESET_MUST_COALESCE. When true, replace only the immediately preceding same-lease mechanical workspace head under exact-head fencing.' },
    },
    additionalProperties: false,
});
