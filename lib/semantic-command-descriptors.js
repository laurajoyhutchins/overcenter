...
const DESCRIPTORS = Object.freeze({
    ...
    'project.artifact.bind': descriptor('project.artifact.bind', 'project.artifact.bind', 'Explicitly bind an exact GitHub issue or pull request to one authoritative project obligation when a reasoning agent or operator judges full-coverage equivalence. The command reads exact project authority and provider identity before appending durable binding evidence; it never infers equivalence from titles, labels, or prose. Rebind and revoke require the exact prior binding identity.', projectArtifactBindSchema, 'advanced', WORKER_AND_MCP_EXPOSURE),
