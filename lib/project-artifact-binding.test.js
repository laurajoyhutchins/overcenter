...
import { createProjectArtifactBindingService, classifyProjectArtifactBinding } from './project-artifact-binding.js';
...
test('explicit issue binding is exact, durable, and mechanically satisfiable', async () => {
  ...
  const result = await service.bind({
    ...
    transition_id:'target-obligation',
    provider:{ kind:'issue', number:42 },
