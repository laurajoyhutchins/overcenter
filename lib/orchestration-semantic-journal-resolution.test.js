...
test('production release probes resolve as definitively not applied without another GitHub mutation', async () => {
    const resolutions = [];
  ...
  test('release receipt is attributed only through the exact orchestration semantic request hash', async () => {
    const request = {
  ...
  test('exact template request can use read-only authoritative reconciliation', async () => {
    const request = {
  ...
  test('historical production template row stays indeterminate when exact request identity is incomplete', async () => {
    const fullRequest = {
      template_repo: 'laurajoyhutchins/hugging-face-dataset-template',
  ...
  test('authoritative template ambiguity remains indeterminate and never retries creation', async () => {
    const request = {
      template_repo: 'laurajoyhutchins/hugging-face-dataset-template',
  ...
  test('template recovery uses installation-wide GitHub App scope for destination readback', async () => {
    const candidate = {
      template_repo: 'laurajoyhutchins/hugging-face-dataset-template',
      destination_repo: 'laurajoyhutchins/generated-dataset',
      description: null,
  ...
  test('historical terminal residue remains observable without poisoning live orchestration health', async () => {
  ...
  test('unresolved live residue remains health blocking', async () => {
  ...
  // Migrated to native node:test discovery.