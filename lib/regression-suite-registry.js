...
// deterministic-work-settlement.test.js is discovered and executed directly by node:test.
// exact-revision-verification.test.js is discovered and executed directly by node:test.
// github-actions-storage.test.js is discovered and executed directly by node:test.
// github-auto-merge.test.js is discovered and executed directly by node:test.
// github-repository-metadata.test.js is discovered and executed directly by node:test.
// github-repository-rename.test.js is discovered and executed directly by node:test.
// github-repository-template.test.js is discovered and executed directly by node:test.
// github-milestone.test.js is discovered and executed directly by node:test.
// github-production-promotion.test.js is discovered and executed directly by node:test.
// github-release.test.js is discovered and executed directly by node:test.
...
// github-execution-authority.test.js is discovered and executed directly by node:test.
// github-execution-authority-lease-ref.test.js is discovered and executed directly by node:test.
// github-lease-scoped-changeset.test.js is discovered and executed directly by node:test.
// project-transition-github-workspace.test.js is discovered and executed directly by node:test.
// github-branch-policy.test.js is discovered and executed directly by node:test.
// github-branch-role-runtime.test.js is discovered and executed directly by node:test.
// github-default-branch.test.js is discovered and executed directly by node:test.
// github-delete-branch.test.js is discovered and executed directly by node:test.
import { runGithubIntegrationTests } from 'lib/github-integration.test.js';
// github-pull-request-create.test.js is discovered and executed directly by node:test.
// github-pull-request-ready.test.js is discovered and executed directly by node:test.
// github-required-checks.test.js is discovered and executed directly by node:test.
import { runGithubReviewPacketTests } from 'lib/github-review-packet.test.js';
// github-stack.test.js is discovered and executed directly by node:test.
...
// project-horizon.test.js is discovered and executed directly by node:test.
...
// work-lifecycle.test.js is discovered and executed directly by node:test.
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  // auto_merge migrated to native node:test discovery.
  ...
  // default_branch migrated to native node:test discovery.
  ...
  suite('orchestration', 'project_lifecycle_resume_isolated_contract', 'lib/project-lifecycle-resume.test.js', runProjectLifecycleResumeTests),
