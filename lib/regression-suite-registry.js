...
// github-actions-storage.test.js executes directly through node:test.
// github-auto-merge.test.js executes directly through node:test.
// github-repository-metadata.test.js executes directly through node:test.
// github-repository-rename.test.js executes directly through node:test.
// github-repository-template.test.js executes directly through node:test.
...
// linear-archive.test.js is native node:test and needs no registry import.
...
// scheduled-cycle-completeness.test.js is native node:test and needs no registry import.
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  // actions_storage executes directly through node:test.
  // auto_merge executes directly through node:test.
  // repository_metadata executes directly through node:test.
  // repository_rename executes directly through node:test.
  // repository_template executes directly through node:test.
  ...
  // linear_archive executes directly through node:test.
  suite('orchestration', 'linear_maintenance', 'lib/linear-maintenance.test.js', runLinearMaintenanceTests),
  // scheduled_cycle_completeness executes directly through node:test.
