...
import { runCompactProviderOperationStoreTests } from 'lib/compact-provider-operation-store.test.js';
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  suite('orchestration', 'compact_provider_operation_store', 'lib/compact-provider-operation-store.test.js', runCompactProviderOperationStoreTests),
