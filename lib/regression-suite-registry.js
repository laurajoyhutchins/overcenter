...
import { runCodexExecutionCapacityTests } from 'lib/codex-execution-capacity.test.js';
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  suite('orchestration', 'codex_execution_capacity', 'lib/codex-execution-capacity.test.js', runCodexExecutionCapacityTests),
