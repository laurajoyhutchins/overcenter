...
import { runProjectArtifactBindingTests } from 'lib/project-artifact-binding.test.js';
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  suite('orchestration', 'project_artifact_binding', 'lib/project-artifact-binding.test.js', runProjectArtifactBindingTests),
