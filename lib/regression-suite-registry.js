...
import { runScheduledMaintenanceTerminalizationTests } from 'lib/scheduled-maintenance-terminalization.test.js';
import { runScheduledRecoveryCompletenessTests } from 'lib/scheduled-recovery-completeness.test.js';
...
import { runWorkerBoundaryRetrySafetyTests } from 'lib/worker-boundary-retry-safety.test.js';
import { runWorkerTransportRuntimeTests } from 'lib/worker-transport-runtime.test.js';
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  suite('orchestration', 'worker_transport_runtime', 'lib/worker-transport-runtime.test.js', runWorkerTransportRuntimeTests),
  suite('orchestration', 'worker_boundary_retry_safety', 'lib/worker-boundary-retry-safety.test.js', runWorkerBoundaryRetrySafetyTests),
  ...
  suite('orchestration', 'scheduled_maintenance_terminalization', 'lib/scheduled-maintenance-terminalization.test.js', runScheduledMaintenanceTerminalizationTests),
  suite('orchestration', 'scheduled_recovery_completeness', 'lib/scheduled-recovery-completeness.test.js', runScheduledRecoveryCompletenessTests),
