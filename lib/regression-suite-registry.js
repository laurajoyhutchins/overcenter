...
import { runPortfolioActionsStorageTests } from 'lib/portfolio-actions-storage.test.js';
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  suite('orchestration', 'portfolio_actions_storage', 'lib/portfolio-actions-storage.test.js', runPortfolioActionsStorageTests),
