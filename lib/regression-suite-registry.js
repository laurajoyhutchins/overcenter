...
import { runOvercenterProjectGraphDeriverTests } from 'lib/overcenter-project-graph-deriver.test.js';
...
import { runProjectDefinitionDiscoveryTests } from 'lib/project-definition-discovery.test.js';
import { runProjectDefinitionFactsReaderTests } from 'lib/project-definition-facts-reader.test.js';
import { runProjectDefinitionFactsTests } from 'lib/project-definition-facts.test.js';
...
import { runProjectGraphAuthorityTests } from 'lib/project-graph-authority.test.js';
...
import { runProjectObservationReaderTests } from 'lib/project-observation-reader.test.js';
import { runProjectRepositoryFactsTests } from 'lib/project-repository-facts.test.js';
import { runProjectRepositoryFactsReaderTests } from 'lib/project-repository-facts-reader.test.js';
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  suite('orchestration', 'project_definition_discovery', 'lib/project-definition-discovery.test.js', runProjectDefinitionDiscoveryTests),
  suite('orchestration', 'project_definition_facts', 'lib/project-definition-facts.test.js', runProjectDefinitionFactsTests),
  suite('orchestration', 'project_definition_facts_reader', 'lib/project-definition-facts-reader.test.js', runProjectDefinitionFactsReaderTests),
  suite('orchestration', 'project_graph', 'lib/project-graph.test.js', runProjectGraphTests),
  suite('orchestration', 'overcenter_project_graph_deriver', 'lib/overcenter-project-graph-deriver.test.js', runOvercenterProjectGraphDeriverTests),
  suite('orchestration', 'project_graph_authority', 'lib/project-graph-authority.test.js', runProjectGraphAuthorityTests),
  ...
  suite('orchestration', 'project_observation_reader', 'lib/project-observation-reader.test.js', runProjectObservationReaderTests),
  suite('orchestration', 'project_repository_facts', 'lib/project-repository-facts.test.js', runProjectRepositoryFactsTests),
  suite('orchestration', 'project_repository_facts_reader', 'lib/project-repository-facts-reader.test.js', runProjectRepositoryFactsReaderTests),
