...
// github-auto-merge.test.js and github-repository-metadata.test.js execute through native node:test discovery.
...
// Native node:test suites are discovered directly by scripts/test.mjs.
...
// project-repository-facts.test.js is discovered and executed directly by node:test.
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  // auto_merge and repository_metadata execute through native node:test discovery.
  ...
  // github release executes through native node:test discovery.
  ...
  // project_horizon executes through native node:test discovery.
  ...
  // project_repository_facts migrated to native node:test discovery.
