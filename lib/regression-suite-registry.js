...
import { runSourceSyncPackageBoundaryTests } from 'lib/source-sync-package-boundary.test.js';
...
export const REGRESSION_SUITES = Object.freeze([
  ...
  suite('source_sync', 'source_sync_package_boundary', 'lib/source-sync-package-boundary.test.js', runSourceSyncPackageBoundaryTests),
]);
