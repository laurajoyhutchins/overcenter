// command-response.test.js runs through native node:test discovery.
...
// github-apply-changeset.test.js runs through native node:test discovery.
...
// github-integration.test.js runs through native node:test discovery.
...
// github-review-packet.test.js runs through native node:test discovery.
...
// project-agent-session-boundary-regression.js runs through native node:test discovery.
// orchestration.test.js runs through native node:test discovery.
...
// portfolio-reconcile-work-surface.test.js runs through native node:test discovery.
...
// project-authoring-github-runtime.test.js runs through native node:test discovery.
...
// project-graph.test.js runs through native node:test discovery.
...
// scheduled-cycle-completeness.test.js runs through native node:test discovery.
...
export const REGRESSION_SUITES = Object.freeze([
  // command_response migrated to native node:test discovery.

  // integration migrated to native node:test discovery.
  ...
  // apply_changeset migrated to native node:test discovery.
  ...
  // review_packet migrated to native node:test discovery.
  ...
  // orchestration migrated to native node:test discovery.
  ...
  // project_agent_session_boundary migrated to native node:test discovery.
  ...
  // project_authoring_github_runtime migrated to native node:test discovery.
  // project_authoring_recovery migrated to native node:test discovery.
  // project_graph migrated to native node:test discovery.
  ...
  // portfolio_reconcile migrated to native node:test discovery.
  ...
  // scheduled_cycle_completeness migrated to native node:test discovery.
