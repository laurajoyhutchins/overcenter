...
import { STAGE_COMMANDS } from 'lib/work-lifecycle.js';
...
export const scheduledCycleParticipants = Object.freeze([
  Object.freeze({ id:'portfolio-dispatcher', stage:'ENABLE', command:STAGE_COMMANDS.ENABLE, title:'Enable', minute:0, automation_id:'6a74054183c88191a47278f43c61a4dd' }),
  Object.freeze({ id:'source-data-implementation', stage:'ACQUIRE', command:STAGE_COMMANDS.ACQUIRE, title:'Acquire', minute:12, automation_id:'6a74053648d88191bdcf9e6ad4ed1d8c' }),
  Object.freeze({ id:'repository-implementation', stage:'EXECUTE', command:STAGE_COMMANDS.EXECUTE, title:'Execute', minute:24, automation_id:'6a74051febd08191a86e737908a3e322' }),
  Object.freeze({ id:'portfolio-integration', stage:'COMMIT', command:STAGE_COMMANDS.COMMIT, title:'Commit', minute:36, automation_id:'6a740515088481919dd97d3be5d89b64' }),
  Object.freeze({ id:'exact-head-verification', stage:'CONFIRM', command:STAGE_COMMANDS.CONFIRM, title:'Confirm', minute:48, automation_id:'6a74052aeeb48191a22b828fc8ecb715' }),
]);
