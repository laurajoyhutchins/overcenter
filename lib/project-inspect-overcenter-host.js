...
export function projectInspectFor(options = {}) {
  ...
  return Object.freeze({
    async inspect(input = {}) {
      ...
      const frontierDetails = Object.freeze(readTransitionOccupancy
        ? await mapInBatches(frontier, FRONTIER_OCCUPANCY_CONCURRENCY, async (id, index) => {
        ...
        : frontier.map((id) => occupancyDetail(id, null)));
