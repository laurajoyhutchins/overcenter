...
export async function runGithubLeaseScopedChangesetTests(){
  ...
  results.push(await run('same-lease final-newline cleanup coalesces the preceding mechanical head into one linear repair commit',async()=>{
  ...
  results.push(await run('exact coalescing replay returns the durable replacement receipt without rewriting the ref',async()=>{
  ...
  results.push(await run('coalescing rejects a different lease before Git mutation',async()=>{
  ...
  results.push(await run('coalescing rejects stale workspace movement before Git mutation',async()=>{
  ...
  results.push(await run('coalescing rejects a non-mechanical predecessor before ref replacement',async()=>{
  ...
  results.push(await run('coalescing preserves possible mutation certainty when ref replacement cannot be reconciled',async()=>{
