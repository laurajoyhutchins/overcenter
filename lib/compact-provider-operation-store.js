...
export function createCompactProviderOperationPostgresStore(dbBinding) {
  ...
  return Object.freeze({ get, claim, heartbeat, updateRecovery, resumeIndeterminate, markIndeterminate, succeed, reject, resolveNoEffect, abandon, listPending, listByScope });
}