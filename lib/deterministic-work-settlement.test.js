...
// Cases execute directly through native node:test discovery.
  ...
  test('scheduler acceptance incompleteness is reported but does not fail an otherwise matching accounting cycle', async () => {
    const ids = ['2026-08-21T19:00:00.000Z','2026-08-21T20:00:00.000Z','2026-08-21T21:00:00.000Z'];
  ...
  test('historical incident does not need to remain executable while corrective actions are pending', async () => {
