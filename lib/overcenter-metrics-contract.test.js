...
test('top-level metric is verified transitions per agent execution boundary', async () => {
  ...
  test('required metric families retain drill-down identity and coverage semantics', async () => {
    const required = [
  ...
  test('authoring reconciliation trigger is a dimension, never authority', async () => {
  ...
  test('existing durable sources and new instrumentation needs are explicit', async () => {
  ...
  test('ambiguous denominator, identity, and historical coverage fail closed', async () => {
