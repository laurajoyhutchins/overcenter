...
// Native test registration is module-scoped.
  ...
  test('already compliant is idempotent and does not mutate', async () => {
  ...
  test('no required checks creates an active branch ruleset and verifies', async () => {
    const steps = [
      ...commonInitial(),
      ...commonPrecondition(),
      {
  ...
  test('existing unrelated requirement is preserved during additive update', async () => {
  ...
  test('missing administration permission is a structured failure with exact authority evidence', async () => {
    const steps = [
      ...commonInitial(),
      ...commonPrecondition(),
  ...
  test('unknown check rejects before mutation', async () => {
  ...
  test('material protection change between inspection and write fails closed', async () => {
    const steps = [
      ...commonInitial(),
      { method: 'GET', result: branchResponse() },
  ...
  test('2xx mutation without authoritative enforcement is not success', async () => {
    const steps = [
      ...commonInitial(),
      ...commonPrecondition(),
  ...
  test('mutation succeeds, verification transport is lost, and retry converges without duplicate configuration', async () => {
