...
const REFRESH_AUTHORITY_CODES = new Set([
  ...
  'GITHUB_AUTO_MERGE_STATE_CHANGED', 'GITHUB_REPOSITORY_METADATA_STATE_CHANGED', 'GITHUB_MILESTONE_STATE_CHANGED', 'GITHUB_DEFAULT_BRANCH_CHANGED', 'GITHUB_INTEGRATION_RECOMPUTE_REQUIRED',
]);
