...
register(['REPOSITORY_ARCHIVE_INDETERMINATE'], 'upstream', true, 502);
...
const REFRESH_AUTHORITY_CODES = new Set([
  ...
  'GITHUB_REPOSITORY_ID_MISMATCH', 'GITHUB_AUTO_MERGE_STATE_CHANGED', 'GITHUB_DEFAULT_BRANCH_CHANGED', 'GITHUB_INTEGRATION_RECOMPUTE_REQUIRED',
]);
